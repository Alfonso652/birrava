...
## Pendiente de despliegue (hacerlo Claude; el usuario solo hace los logins)
...
2. Login (interactivo, lo hace el usuario con `!` en el prompt): `gh auth login` y `npx supabase login`.
...
- Commits sin líneas de atribución de Claude.
